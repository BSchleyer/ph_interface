...
$productInfo = requestBackend($config, ["id" => 17], "pteroGetProduct")["response"];
            ...
            <div class="row">
                <div class="col-sm-7">
                    <div class="header-text">
                        <h2><?php echo $productInfo["displayname"]; ?> <?php  echo $lang->getString("gameserver"); ?></h2>
                        <p><?php  echo $lang->getString("gameservermct"); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="table table-striped custab">
                ...
                <?php
                    foreach ($productInfo["packets"] as $packetInfo) {
                        ...
                        echo '<td><a class="btn btn-small btn-green" href="' . $url . '/cp/app/order/' . $productInfo["id"] . '">Bestellen<i class="fas fa-share"></i></a></td>';
                        echo '</tr>';
                    }
                ?>
            </table>
                ...
                <div class="box-shadow">
                    <div class="list-features">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <ul>
                                    <li><i class="fa fa-plus"></i> <?php  echo $lang->getString("unlimitedslots"); ?></li>
                                    <li><i class="fa fa-plus"></i> <?php  echo $lang->getString("simpleinterface1"); ?></li>
                                    <li><i class="fa fa-plus"></i> <?php  echo $lang->getString("sftpmc"); ?></li>
                                    <li><i class="fa fa-plus"></i> <?php  echo $lang->getString("simpleinterface3"); ?></li>
                                    <li><i class="fa fa-plus"></i> <?php  echo $lang->getString("pcoketminemc"); ?></li>
