...
$productInfo = requestBackend($config, ["id" => 13], "pteroGetProduct")["response"];
...
<!-- table end-->
    ...
    <div class="call-to-action2">
        <div class="custom-width">
            <div class="row">
                <div class="col-sm-12">
                    <h4><?php  echo $lang->getString("servermc"); ?></h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <ul>
                                    ...
                                    <li><i class="fa fa-plus"></i> <?php  echo $lang->getString("javamc"); ?></li>
