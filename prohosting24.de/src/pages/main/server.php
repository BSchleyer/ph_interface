        ...
        <div class="row">
            <div class="col-sm-7">
                <div class="header-text">
                    <h2>' .$lang->getString("servershead") .'</h2>
                    <p>' .$lang->getString("serversheadt") .'</p>
                    <h4>' .$lang->getString("startingat") .'</h4>
                    <h3>€ 3,90 / ' .$lang->getString("month") .'</h3>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="box-container box1">
                    ...
                    <h4>' .$lang->getString("scalablekvm") .'</h4>
                    <p>' .$lang->getString("scalablekvmt") .'</p>
                    <div class="buttons">
                        <a href="' . $url . '/' .$lang->getString("vps") .'" class="btn btn-outline btn-medium">' .$lang->getString("vserver") .'</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="box-container box2">
                    ...
                    <h4>' .$lang->getString("packagedkvm") .'</h4>
                    <p>' .$lang->getString("packagedkvmt") .'</p>
                    <div class="buttons">
                        <a href="' . $url . '/' .$lang->getString("vpsplans") .'" class="btn btn-outline btn-medium">' .$lang->getString("vserverpackage") .'</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="box-container box3">
                    ...
                    <h4>' .$lang->getString("applications") .'</h4>
                    <p>' .$lang->getString("applicationst") .'</p>
                    <div class="buttons">
                        <a href="' . $url . '/apps" class="btn btn-outline btn-medium">' .$lang->getString("learnmore") .'</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="custom-width">
        ...
        <div class="accordion">
            <div class="accordion-item">
                <a>' .$lang->getString("faq1q") .'</a>
                <div class="content">
                    <p>' .$lang->getString("faq1a") .'</p>
                </div>
            </div>
            <div class="accordion-item">
                <a>' .$lang->getString("faq2q") .'</a>
                <div class="content">
                    <p>' .$lang->getString("faq2a") .'</p>
                </div>
            </div>

            <div class="accordion-item">
                <a>' .$lang->getString("faq3q") .'</a>
                <div class="content">
                    <p>' .$lang->getString("faq3a") .'</p>
                </div>
            </div>
