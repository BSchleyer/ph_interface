...
if (!checkpost($_POST, ["id", "entryName", "entryType"])) {
...
$apirespond = requestBackend($config, ["id" => $_POST["id"],"entryName" => $_POST["entryName"],"entryType" => $_POST["entryType"]], "deletednsentry");
