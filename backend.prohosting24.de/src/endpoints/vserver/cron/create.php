...
if (!checkpost($_POST, ["vserverid", "minute", "hour", "day_month", "month", "day_week", "action", "name"])) {
...
try {
    $cronObject = new Cron\CronExpression($_POST["minute"] . " " . $_POST["hour"]. " " . $_POST["day_month"]. " " . $_POST["month"]. " " . $_POST["day_week"]);
}catch (Exception $e){
...
$cron->setValue("vserverid", $_POST["vserverid"]);
